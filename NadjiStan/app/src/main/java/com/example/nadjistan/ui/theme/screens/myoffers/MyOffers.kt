...
@Composable
fun MyOffers(ovm : myOffersViewModel, goBack : () -> Unit, filter : () -> Unit, reset : () -> Unit, set : (Ponude) -> Unit, map : () -> Unit){
    Column(modifier = Modifier
        ...
        Row(modifier = Modifier
            ...
            Text(text = "Moje ponude", fontSize = 35.sp, color = MaterialTheme.colorScheme.onPrimary, modifier  = Modifier.padding(15.dp))
        }
        Column (modifier = Modifier
            .fillMaxHeight(0.9f)
                ...
                Row(
                    ...
                    )
                    {
                        ...
                        Row(
                            ...
                            Text(text = GetStirng(ponuda.tip), fontSize = 15.sp)
                            Text(
